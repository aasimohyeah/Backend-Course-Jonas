...
exports.getToursWithin = catchAsync(async (req, res, next) => {
  ...
  //^dividing by radius of earth, first in mi, then in km
...
exports.getDistances = catchAsync(async (req, res, next) => {
  ...
  //^to scale value to miles and km
  ...
  //MongoDB Aggregation pipelines can be used to get insights from our data,
  //eg: avg, total, max, min etc
  const distances = await Tour.aggregate([
    ...
    {
      $project: {
        distance: 1, //1 means show it
        name: 1, //1 means show it
      },
    },
  ]);
